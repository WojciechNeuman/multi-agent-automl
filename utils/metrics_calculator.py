...
def calculate_metrics(
    ...
    if problem_type == "classification":
        ...
        metrics["train_precision"] = precision_score(y_train_true, y_train_pred, average="weighted", zero_division=0)
        metrics["test_precision"] = precision_score(y_test_true, y_test_pred, average="weighted", zero_division=0)
        metrics["train_recall"] = recall_score(y_train_true, y_train_pred, average="weighted", zero_division=0)
        metrics["test_recall"] = recall_score(y_test_true, y_test_pred, average="weighted", zero_division=0)
        metrics["train_f1_score"] = f1_score(y_train_true, y_train_pred, average="weighted", zero_division=0)
        metrics["test_f1_score"] = f1_score(y_test_true, y_test_pred, average="weighted", zero_division=0)
